...
class My_prognozApp(App):
    ...
    # переменные и добавление всего в окно
    def __init__(self):
        super().__init__()
    ...
    # функция по выводу температуры и т.д
    ...
    # Чарли и фабрика по созданию виджетов, а точнее создание всего и вся
